...
/* ⭐ 动态更新 UI：根据选择的产品展示平台 */
"function updateUI(){"
"const selectedProductCode = document.getElementById('productLine').value;"
"const modelSelect = document.getElementById('model');"
"modelSelect.innerHTML = '';"
"const product = g_serverProducts.find(p => p.code === selectedProductCode);"

"if (product && product.platform) {"
"    let o = document.createElement('option');"
"    o.text = product.platform;"
"    o.value = product.platform;"
"    modelSelect.add(o);"
"} else {"
"    let o = document.createElement('option');"
"    o.text = '无平台信息';"
...
"const productLineCode = document.getElementById('productLine').value;"
"const platformValue = document.getElementById('model').value;"
...
"platform_code: platformValue,"
"product_code: productLineCode,"
